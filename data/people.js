...
window.SITE_PEOPLE = [
  ...
  },
  {
    ...
    affiliation: "UC Riverside",
    category: "pi",
    bio: "Hai-Bo Yu is a Professor of Physics and Astronomy at the University of California, Riverside, and Deputy Director of the university's Center for Experimental Cosmology and Instrumentation. A theoretical physicist specializing in the particle properties of dark matter, he is among the researchers who helped revive and develop the self-interacting dark matter (SIDM) paradigm, in which dark matter particles collide and exchange energy. His work shows how SIDM can reshape the central regions of halos and how dense, gravothermally collapsed clumps of self-interacting dark matter can simultaneously account for anomalies in gravitational lenses, stellar streams, and satellite galaxies. Within the Targeted Simons Research Group on Dark Matter Dynamics, Yu provides core theoretical leadership on SIDM physics and its mapping onto galactic- and cluster-scale observables. His research program connects the fundamental interactions of dark matter to a broad range of astrophysical phenomena across cosmic environments."
  }
